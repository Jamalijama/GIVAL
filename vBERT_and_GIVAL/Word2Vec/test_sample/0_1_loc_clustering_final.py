...
method_name = '10w_256cut_38w_NP_diff_loc_word2vec'
...
#loc_lst = [16, 109, 313, 319, 357]
loc_lst = [16, 313, 319, 357]
#loc_lst = [158, 199, 253, 256, 271, 535, 588, 590, 591, 627, 636, 684, 701, 702, 714]
n_clustered = len(loc_lst)
#array = np.load(npy_file, allow_pickle=True)
array = pickle.load(open(npy_file,'rb'))
...
for l in range(len(loc_lst)):
    ...
    label = [loc_lst[l] for _ in range(len(array))]
