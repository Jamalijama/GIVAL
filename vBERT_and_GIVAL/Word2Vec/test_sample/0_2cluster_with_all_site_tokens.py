...
codon_len = 499 - 1
target_loc_lst = [16, 109, 283, 313, 319, 357]
# target_loc = 357
...
npy_file = 'NP_word2vec_HMM_feature.pkl'
array1 = pickle.load(open(npy_file,'rb'))
...
for target_loc in target_loc_lst:
    ...
    # kmeans
    method_name = 'word2vec_10w_256cut_38w_kmeans_' + str(target_loc) + '_' + str(n_clustered) + '_' + str(num)
    ...
    df_tsne_all.to_csv('df_tsne_with_label_'+method_name+'.csv',index=False)
