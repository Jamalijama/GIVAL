...
array = np.load('./txt_npy_file/new/for_predict_model_token_onlywith_HMM.npy', allow_pickle=True)
array_test = np.load('./txt_npy_file/new/token_onlywith_HMM_target_seq.npy', allow_pickle=True)
#padding
dim_model = 16
...
for a in range(2):
    ...
    plt.savefig('sns_scatterplot_PCA_' + method_name + '.png', dpi = 300, bbox_inches = 'tight')
'''
