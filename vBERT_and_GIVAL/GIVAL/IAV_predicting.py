...
unmapped_seg = ['HA', 'NA', 'M', 'NS']
seg_lst = ['PB2', 'PB1', 'PA','NP', 'HA', 'NA', 'M', 'NS']
cds_lst = ['1', '2', '3', '5', '4', '6', '7', '8']
...
if loc_lst0[2] not in unmapped_seg:
    ...
    if (loc_lst0[2] == 'NA')|(loc_lst0[2] == 'HA'):
        file = './csv_file/' + loc_lst0[2] + '_without_test_set_DCR_human_avian_sampled_with_ref.csv'
    else:
        file = './csv_file/new_AIV_PB2_PB1_PA_M_NS_sampled_human_avian1000.csv'
    df = pd.read_csv(file)
...
if (loc_lst0[2] == 'NA')|(loc_lst0[2] == 'HA')|(loc_lst0[2] == 'NP'):
    file = './csv_file/' + loc_lst0[2] + '_without_test_set_DCR_human_avian_sampled_with_ref.csv'
else:
    file = './csv_file/new_AIV_PB2_PB1_PA_M_NS_sampled_human_avian1000.csv'
df_all_information = pd.read_csv(file)
...
tests = list(X_test)
f1 = open('./pkl_file/composition_cut/test_quiring_composition_cut.pkl','wb')
pickle.dump(tests,f1)
...
num_classes_lst = [num_classes]
df_1 = pd.DataFrame()
df_1['num_classes'] = num_classes_lst
df_1.to_csv('num_classes.csv',index=False)
