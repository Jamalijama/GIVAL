...
#extract_feature
method_name1 = gene+'_for_predict_model_H5N1_mutants_predicting_30000'
file = './test_set/test_H5N1/create_new_seq_from_Texas_ref_seq_and_bayes_30000.csv'
df = pd.read_csv(file)
df['Host'] = ['Mutant' for i in range(len(df))]

npy_file = './test_set/test_H5N1/create_new_seq_from_Texas_ref_seq_and_bayes_30000.npy'
