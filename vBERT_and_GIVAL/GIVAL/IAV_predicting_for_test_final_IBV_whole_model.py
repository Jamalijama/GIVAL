...
#extract_feature
method_name = gene+'_for_predict_model_IBV_whole_model'

txt_file = './test_set/IBV/IBV_20200101-20231231_99.txt'
npy_file = './test_set/IBV/IBV_20200101-20231231_99.npy'
...
file = './test_set/IBV/IBV_20200101-20231231_99.csv'
df = pd.read_csv(file)
