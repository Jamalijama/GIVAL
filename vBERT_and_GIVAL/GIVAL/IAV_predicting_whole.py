...
df_H3 = df_H3[df_H3['Host']=='Human']
df_H1 = df_all_information[(df_all_information['Serotype_new_H']=='H1')&(df_all_information['Host']=='Human')]
df_Avi = df_all_information[(df_all_information['Host']=='Avian')&((df_all_information['Serotype_new_H']=='H5')|(df_all_information['Serotype_new_H']=='H9')|(df_all_information['Serotype_new_H']=='H7'))]
df_all_information = pd.concat([df_H3,df_H1,df_Avi],ignore_index=True)
...
tests = list(X_test)
f000 = open('./pkl_file/composition_cut/test_composition_cut.pkl','wb')
pickle.dump(tests ,f000)
