...
#extract_feature
method_name1 = gene+'_for_predict_model_H5N1_mutants_predicting_other_site_mutate_back'
file = './test_set/test_H5N1/first_bayes_mutate_back/other_18_site_mutate_back/top_12_sites_based_on_first_bayes_30000_seq.csv'
df = pd.read_csv(file)
df['Host'] = ['Mutant' for i in range(len(df))]

npy_file = './test_set/test_H5N1/first_bayes_mutate_back/other_18_site_mutate_back/top_12_sites_based_on_first_bayes_30000_seq.npy'
