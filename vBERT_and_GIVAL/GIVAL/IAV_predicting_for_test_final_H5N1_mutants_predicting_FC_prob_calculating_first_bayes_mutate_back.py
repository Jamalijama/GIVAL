...
#extract_feature
method_name1 = gene+'_for_predict_model_H5N1_mutants_predicting_first_bayes_mutate_back'
file = './test_set/test_H5N1/first_bayes_mutate_back/first_bayes_30000_result_human_low_FC_prob_less_055_mutate_back.csv'
df = pd.read_csv(file)
df['Host'] = ['Mutant' for i in range(len(df))]

npy_file = './test_set/test_H5N1/first_bayes_mutate_back/first_bayes_30000_result_human_low_FC_prob_less_055_mutate_back.npy'
